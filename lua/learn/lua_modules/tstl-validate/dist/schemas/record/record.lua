...
local ____index = require("learn.lua_modules.tstl-validate.dist.schemas.string.index")
local ____string = ____index.string
local ____values = require("learn.lua_modules.tstl-validate.dist.schemas.record.values")
